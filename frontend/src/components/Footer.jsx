    ...
    <div>
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-4 md:gap-x-12">
                    <div>
                        ...
                        <ul className="mt-8 space-y-4">
                            ...
                            <li className='border-0'>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80 border-0"> Features </a>
                            </li>
                            <li className='border-0'>
                    ...
                    <div>
                        ...
                        <ul className="mt-8 space-y-4">
                            ...
                            <li className='border-0'>
                                <a href="#" title="" className="text-base text-white border-none transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Privacy Policy </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="flex  items-center justify-between">
                    ...
                    <img className="h-16 auto md:order" src={logo} alt="" />
                    <h2 className=' ml-2  text-4xl text-green-200'>Shoeping</h2>
                    </div>
