...
const AboutSection = () => {
  return (
    <>
    <Box padding={"2vw 5vh"} bg={"#1a202c"} color={"white"} mb={ 0}> <VStack ><Heading color={"white"} padding={"2vh"} bg="pink.500" border={"2px solid pink"} mb={5}>Let's Know more about us</Heading></VStack>
