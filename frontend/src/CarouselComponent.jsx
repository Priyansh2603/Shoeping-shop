...
const Carousel = () => {
  ...
  return (
    <Box position="relative" overflow="hidden" width="100%" height="70vh" >
      {slides.map((slide, i) => (
        <Box
          key={slide.id}
          position="absolute"
          ...
          alignItems="center"
        >
          <img src={slide.image} alt={slide.alt} style={{ maxWidth: '100%', maxHeight: '90%' }} />
      ...
      <Button position="absolute" right="3" top="50%" onClick={handleNext}>
